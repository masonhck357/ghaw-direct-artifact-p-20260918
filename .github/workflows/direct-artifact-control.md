...
"on":
  workflow_run:
    workflows: ["GHAW direct artifact relay control"]
    types: [completed]
    branches: [main]
    conclusion: success
  roles: all
...
```bash
gh run download 35421579872 --repo masonhck357/ghaw-direct-artifact-a-20260918 --name artifact-path-control --dir /tmp/ghaw-direct-artifact-control
GHAW_EXPECTED_TOKEN_SHA256=698f3736deaa6e21def49178874a6fabd65fec8abed20aa63e705f02623f0959 PATH=/tmp/ghaw-direct-artifact-control:$PATH gh --version
```
